...
public partial class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27946ACF5B");
        ...
        modelBuilder.Entity<CatProd>(entity =>
        {
            ...
            entity.Property(e => e.NumOfProducts).HasColumnName("Num Of Products");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B48217CA55");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB851DDF45D5");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229FDF5E887");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4F3219639");
        ...
        modelBuilder.Entity<OrdersCompleted>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("orders_completed", "sales");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF59BF544D7");
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__promotio__2CB9556BC3C5CE21");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C5DD82305");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164F153E8D7").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3B48C4CF4");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C87133F5B");
